...
module SevenEvent
  RSpec.describe EventsController, type: :controller do
    ...
    let(:invalid_event) {
      FactoryGirl.create(:invalid_event)
    }

    let(:valid_attributes) {
      FactoryGirl.attributes_for(:valid_event)
    }

    let(:invalid_attributes) {
      FactoryGirl.attributes_for(:invalid_event)
    }
    ...
    describe "PUT #update" do
      context "with valid params" do
        let(:new_attributes) {
          FactoryGirl.attributes_for(:valid_event, title: "new_title")
        }
